...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/assets/pdf/Maryam_S_Cheema.pdf";
          },
        ...
        handler: () => {
          ...
          description: "",
          section: "Books",handler: () => {
              window.location.href = "/books/ladytan/";
            },},{id: "books-as-long-as-the-lemon-trees-grow",
          title: 'As Long as the Lemon Trees Grow',
          description: "",
          section: "Books",handler: () => {
              window.location.href = "/books/lemon_trees/";
            },},{id: "books-the-lion-women-of-tehran",
          title: 'The Lion Women of Tehran',
          description: "",
          section: "Books",handler: () => {
              window.location.href = "/books/lionWomen/";
            },},{id: "books-arabian-love-poems",
          title: 'Arabian Love Poems',
          description: "",
          section: "Books",handler: () => {
              window.location.href = "/books/love_poems/";
          ...
          description: "",
          section: "Books",handler: () => {
              window.location.href = "/books/parables/";
            },},{id: "books-the-island-of-sea-women",
          title: 'The Island of Sea Women',
          description: "",
          section: "Books",handler: () => {
              window.location.href = "/books/sea_women/";
            },},{id: "books-maybe-you-should-talk-to-someone",
          title: 'Maybe You Should Talk to Someone',
          description: "",
          section: "Books",handler: () => {
              window.location.href = "/books/the_godfather/";
            },},{id: "books-a-town-like-alice",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6D%63%68%65%65%6D%61%32@%61%73%75.%65%64%75", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=Az7CDq4AAAAJ&hl", "_blank");
        },
      },{
      id: 'light-theme',
